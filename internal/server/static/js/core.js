...
const fmtCost = n => n === 0 ? '$0.00' : n >= 1 ? '$' + n.toFixed(2) : '$' + parseFloat(n.toFixed(4));
...
const I18N = {
  en: {
    ...
    branch: 'Branch', created: 'Created', updated: 'Updated', time: 'Time', tokens: 'Tokens', cost: 'Cost', refresh: 'Refresh',
  ...
  zh: {
    ...
    branch: '分支', created: '创建时间', updated: '修改时间', time: '时间', tokens: 'Tokens', cost: '费用', refresh: '刷新',
    sessionLog: '会话记录',
    ...
    manualAlias: '手动别名', newAlias: '新增别名', editAlias: '编辑别名', rawAlias: '原始模型 / 别名', canonicalModel: '规范模型', canonicalTarget: '建议映射', candidateSources: '建议别名', mapsTo: '映射到', moreAliases: '+{count} 项', pendingAliasCount: '{count} 个待处理别名', saveAlias: '保存别名', noAliases: '暂无模型别名。', aliasCandidates: '候选', noAliasCandidates: '暂无疑似别名候选。', currentModel: '当前映射', pendingAlias: '待处理', usedAlias: '已使用', pendingAliases: '待处理 {count} 项', allAliasesUsed: '已全部使用', toggleCandidate: '展开或收起 {model}', applyGroup: '应用 {count} 项', applyGroupConfirm: '将 {count} 个别名应用到 {model}？', use: '使用', manualAliasSource: '手动', configAliasSource: '配置', aliasRequired: '别名和规范模型不能为空。'
  }
};

// ── State ──
const colors = ['#3b82f6', '#22c55e', '#f59e0b', '#ef4444', '#8b5cf6', '#06b6d4', '#f97316', '#ec4899'];
const SOURCE_LABEL_KEYS = { claude: 'claudeCode', codex: 'codex', openclaw: 'openClaw', opencode: 'openCode', mimocode: 'mimoCode', kiro: 'kiro', pi: 'pi' };
